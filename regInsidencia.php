 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Ver Seleccion alumno para Generar Incidencia</a>
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">SELECCIONE ALUMNO A GENERAR INCIDENCIA</h4>
...
join tipogrado t on g.idTipo=t.idTipo
where  g.est=1;";
                                        $resultado = $mysqli->query($query);
                                        while($row = $resultado->fetch_array())
                                        {?>
...
<br>
 ...
 <script type="text/javascript" src="js/baluInsidencia.js"></script>
    <?php 
