 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Ver Seleccion alumno para Generar Insidencia </a>
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">SELECCIONE ALUMNO A GENERAR INSIDENCIA</h4>
...
<br>
 ...
 <script type="text/javascript" src="js/blistaAlumno.js"></script>
    <?php 
