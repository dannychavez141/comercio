...
<div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
    <div class="breadcrumb-wrapper col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="verDocenteAsig.php">Lista de Docentes</a>
            </li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" v-model="curso" onclick="fichasDoc()" >
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="checkbox"  class="form-control" v-model="chktodos" onclick="fichasDoc()"> 
                                                        ...
                                                        <table border="2" class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                <tr v-for="ficha in fichas">
                                                                    ...
                                                                    <td>{{ficha['fecha']}}</td>
                                                                    <td><a v-bind:href="'./reporteexcel/repFicha.php?id='+ficha['idfichacontrol']" target="_blank"><button type="button">VER FICHA</button></a></td>
                                                                </tr>
