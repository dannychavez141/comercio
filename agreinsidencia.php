...
<li class="breadcrumb-item"><a href="regInsidencia.php">Seleccion de alumno para registrar incidencia</a>
                </li>
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form">Registrar Incidencia</h4>
                        ...
                        <form class="form" action="control/cIncidencia.php" method="post" id="registro">
                            <div class="form-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput2">Fecha de Incidencia</label>
                                         <input type="date" name="fec" class="form-control" value="<?php echo $dia ?>">
                                        </div>
                                    </div>
                                   <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Tipo Incidencia</label>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="projectinput2">Describir Incidencia</label>
                                          <textarea class="form-control" name="descr" placeholder="Escribe descripcion de la Incidencia" required=""></textarea>
                                        </div>
                                    </div>
