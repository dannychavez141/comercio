 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="verCurso.php">Ver Curso</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">Modificando Curso</a>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form">Modificar Curso</h4>
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <div class="card-text">
                            <p>Por favor ingrese los nuevos datos del Curso</p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="cur" class="form-control" onkeypress="return letras(event)" maxlength="40"placeholder="Apellido Paterno" name="cur" required="">
                                        </div>
                                    </div>
                                </div>
