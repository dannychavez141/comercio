                    ...
                    <div class="card-block" style="margin: 3px;padding: 1%; color: black"> 
                            ...
                            <div class="col-xl-4 col-lg-4 col-xs-12">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <h4> Para poder acceder a las clases virtuales con los códigos usted necesita tener un correo institucional @premiumcollege.edu.pe, si no posee el correo, comunicarse con el administrador, de lo contrario no podrá unirse a las clases virtuales</h4>
                                        <a href='../login.php' class='btn btn-success'><img src="../img/logo.png" width="50" height="50" alt="logo"/>
                                            INICIAR SESION</a><br><br>
                        ...
                        <!--    <div class="col-xl-4 col-lg-6 col-xs-12">
                            ...
                            <div class="col-xl-8 col-lg-8 col-xs-12">
                                ...
                                <iframe v-bind:src="horario" width="100%" height="80%" ></iframe>
