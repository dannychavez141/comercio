                    ...
                    <div class="col-md-10">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">Registardo Docente</h4>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <div class="card-text">
                                        <p>Por favor ingrese los datos del Docente a Registrar</p>
                                    </div>
                                    <form class="form" action="control/cDocente.php" method="post" id="registro" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput6">Cargo del trabajador </label>
                                                        <select id="projectinput6" name="tipo" class="form-control">
                                                            <?php
                                                            $query = "SELECT * FROM cargo where est=1;";
...
<?php } ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" v-model="detalle" class="form-control"  maxlength="20"placeholder="Datos Adicionales del Cargo" name="detcargo">
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    $.ajax({
                        ...
                        success: function (datos_dni) {
                            ...
                            if (datos == null) {
                                ...
                                regdoc.dni = datos[0];
                                regdoc.apepa = datos[1];
                                regdoc.apema = datos[2];
                                regdoc.nom = datos[3];
                            }
                            regdoc.btalu = 1;
                            console.log(regdoc.btalu);
                        }
