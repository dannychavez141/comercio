...
<div class="app-content content container-fluid">
    <div class="content-wrapper">
        <div class="content-body"><!-- Basic form layout section start -->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-form">Registrar Ficha de seguimiento de clases virtualess</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" v-model="curso" onclick="competenciCurso(app.curso[6])">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  class="form-control"  v-model="curso['descr']"placeholder="Año Escolar" name="anio" readonly="">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  class="form-control"  v-model="semana" placeholder="N° De Semana" name="anio">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  class="form-control"  v-model="sesion"placeholder="Tema de Sesion" name="anio" >
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div v-for="comp in competencias">
                                                            <input type="checkbox" v-model="competencia" v-bind:value="comp"/> {{ comp['competencia']}}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div> 
                                                            ...
                                                            <table  class="table fixed-top">
                                                                <thead>
                                                                    ...
                                                                    <tr class="bg-success"><th><font size="1"> <p align="center">Apellidos y Nombres</p></font></th>
                                                                        ...
                                                                        <th><font size="1"> <p align="center">Google Meet</p></font></th>
            ...
            <script src="js/rFicha.js" type="text/javascript"></script>
