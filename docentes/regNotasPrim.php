 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="verCursos.php">Seleccion de notas de curso a ingresar</a>
                </li>
...
join alumnos a on m.dnialu=a.dni where m.idGrado=$idgrad and m.idSeccion=$secc and m.idAnioEscolar=$anio and m.est='1' order by a.apepa;";
...
<?php $sql2 = "SELECT * FROM notasalumno n join competencias c on n.idComp=c.idComp where n.idMatricula=$idmat and c.idcurso=$cur and c.est=1;";
                                        ...
                                        <select name="notas[]"  class="browser-default custom-select" ><option value="<?php echo $nota?>"><?php echo notaprim($nota) ?></option>
...
$prom=round($suma);
                            ...
                            ?>
<td>
    <p align="center"><?php echo notaprim($prom) ?></p><button>Guardar</button></td>
