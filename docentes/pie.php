    ...
    <footer class="footer footer-static footer-light navbar-border">
      <p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2019 <a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank" class="text-bold-800 grey darken-2">DaHe </a>, Todos los derechos Reservados Premium College. </span><span class="float-md-right d-xs-block d-md-inline-block">Hecho a mano y hecho con <i class="icon-heart5 pink"></i></span></p>
    </footer>
