 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Ingreso de Notas Inicial y Primaria</a>
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">INGRESO DE NOTAS INICIAL Y PRIMARIA </h4>
...
<section class="principal" >
  <div class="formulario">
    ...
    <input type="hidden" name="idtipo" id="idtipo" value="1"></input>
...
where  g.est=1 and g.idTipo!=2;";
                                    ...
                                    $query = "SELECT * FROM seccion where est=1;";
                                        ...
                                        {?>
                                            ...
                                            <select id="peri" name="seccion" onchange="buscar()">
                                                <?php  
                                    $query = "SELECT * FROM periodos where est=1;";
                                        ...
                                        {?>
                                            ...
                                            <button type="button" onclick="buscar()" class="btn btn-primary">Seleccionar</button>
...
<br>
 ...
 <script type="text/javascript" src="js/bcursoPrimNot.js"></script>
    <?php 
