...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Premium College-No permisos</title>
    ...
    <div class="col-md-6 offset-md-3 col-xs-12 p-0">
        <div class="card border-grey border-lighten-3 px-1 py-1 box-shadow-3">
            ...
            <div class="card-block text-xs-center">
                <h3>USTED NO CUENTA CON PERMISOS PARA ACCEDER A ESTE MODULO</h3>
                <p>Disculpe las molestias.
                    <br> Estamos trabajando para usted.</p>
                <div class="mt-2"><i class="icon-gear-a spinner font-large-2"></i></div>
            </div>
            <hr>
            <p class="socialIcon card-text text-xs-center pt-2 pb-2">
                <a href="index.php"><button type="button" class="btn btn-info">VOLVER A INICIO</button></a>
            </p>
        </div>
    </div>
</section>
