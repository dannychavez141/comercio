 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Ver Asistencias y Salidas</a>
                </li>
              </ol>
            </div>
          </div>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">ASISTENCIAS Y SALIDAS REGISTRADAS </h4>
...
<section class="principal" >
  <div class="formulario">
    ...
    <label for="projectinput6">Fecha:</label> <input type="date" id="fecha" name="fecha" value="<?php echo $hoy ?>" max="<?php echo $hoy ?>" > 
