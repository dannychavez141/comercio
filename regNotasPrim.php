 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="selecCurPrim.php">Seleccion de notas de curso a ingresar</a>
                </li>
...
join alumnos a on m.dnialu=a.dni where m.idGrado=$idgrad and m.idSeccion=$secc and m.idAnioEscolar=$anio order by a.apepa;";
                            ...
                            </td><td><?php echo utf8_decode($dato[2]) ?></td>
...
$prom=round($suma);
                            ...
                            ?>
                                            <td><p align="center"><?php echo notaprim($prom) ?></p><button class="btn btn-primary">Guardar</button></td>
