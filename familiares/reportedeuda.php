...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Premium College-Resporte de deudas</title>
        ...
        <div class="card border-grey border-lighten-3 px-1 py-1 box-shadow-3">
            <div class="card-block">
                <span class="card-title text-xs-center">
                    <img src="/librerias/app-assets/images/logo/logo.png" class="img-fluid mx-auto d-block pt-2" width="250" alt="logo">
                </span>
            </div>
            <div class="card-block text-xs-center">
                <h3>Hola, la entrega de libretas será presencial por estos momentos, por favor acercarse a recogerlo a la institución en el horario planificado.</h3>
                <p>Disculpe las molestias.</p>
                    <br> Estamos trabajando para usted.
                    <br>
                Si usted desea informacion envíenos un correo: dannychavez@premiumcollege.edu.pe o llamar al 991268866</p>
                <div class="mt-2"><i class="icon-gear-a spinner font-large-2"></i></div>
            </div>
            <hr>
            <p class="socialIcon card-text text-xs-center pt-2 pb-2">
               <button type="button" class="btn btn-info" onclick="window.close();">CERRAR PESTAÑA</button>
            </p>
        </div>
    </div>
</section>
