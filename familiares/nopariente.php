    ...
    <div class="col-md-6 offset-md-3 col-xs-12 p-0">
        <div class="card border-grey border-lighten-3 px-1 py-1 box-shadow-3">
            ...
            <div class="card-block text-xs-center">
                <h3>Usted no posee acceso a esta informacion por que no es apoderado de este alumno</h3>
                <p>Disculpe las molestias.
                    <br> Estamos trabajando para usted.
                    <br>
                Si usted está al día con todos sus pagos envíenos un correo: dannychavez141@gmail.com</p>
