 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Registrando Matricula de Inicial o Primaria</a>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form">Registrando Matricula de Inicial o Primaria</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="opc" value="Prim">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
