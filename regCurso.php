 ...
 <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-15 col-xs-12">
            <div class="breadcrumb-wrapper col-xs-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Registrando Curso</a>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form">Registrando Curso</h4>
                ...
                <div class="card-body collapse in">
                    <div class="card-block">
                        <div class="card-text">
                            <p>Por favor ingrese los datos del Curso a Registrar</p>
                        </div>
                        <form class="form" action="control/cCurso.php" method="post" id="registro">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Codigo del curso<font color="red">*</font></label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="projectinput1">Nombre del Curso <font color="red">*</font></label>
                                            <input type="text" v-model="cur" class="form-control" onkeypress="return letras(event)" maxlength="30"placeholder="Nombre del Curso" name="cur" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
